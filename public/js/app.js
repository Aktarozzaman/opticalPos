$(document).ready(function() {
    ...
    $(document).on('change', '.toggler', function() {
        ...
        if ($(this).is(':checked')) {
            ...
            get_sub_categories_for_taxonomy();
        } else {
    ...
    if ($('form#bussiness_edit_form').length > 0) {
        ...
        // License upload
        $('#business_license').fileinput(fileinput_setting);
...
// Customization Script Code Start

//category CRUD add child category
$(document).on('change', '#child_parent_id', function () {
    get_sub_categories_for_taxonomy();
});

function get_sub_categories_for_taxonomy() {
    var cat = $('#child_parent_id').val();
    $.ajax({
        method: 'POST',
        url: '/products/get_sub_categories',
        dataType: 'html',
