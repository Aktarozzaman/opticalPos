    ...
    <nav class="navbar navbar-default bg-white m-4">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{action('\Modules\Superadmin\Http\Controllers\SuperadminController@index')}}"><i class="fa fas fa-user-shield"></i> {{__('superadmin::lang.superadmin')}}</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'coupon') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\CouponController@index')}}">@lang('superadmin::lang.coupon')</a></li>

                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'affiliate') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\AffiliateController@index')}}">Affiliate</a></li>

                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'notice') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\SuperadminNoticeController@edit')}}">Notice</a></li>

                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'superadmin-message') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\SuperadminNoticeController@messageInfo')}}">SMS</a></li>
                </ul>
