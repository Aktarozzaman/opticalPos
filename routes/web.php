...
//        return view('welcome')->with(compact('packages'));
    ...
    Route::get('/affiliat/register', 'AffiliateController@getRegister')->name('affiliat.getRegister');
    Route::post('/affiliat/register/info', 'AffiliateController@postRegister')->name('affiliat.postRegister');
    Route::get('/affiliat', 'AffiliateController@index')->name('affiliat');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('birth-day-list','ContactController@birthDayList')->name('birthdaylist');
    Route::post('store-birth-wish-sms/{id}','ContactController@wishMessage')->name('wishMessage');
    ...
    Route::get('pos/invoice', 'SellPosController@invoice');
    ...
    Route::get('/trial-user','ManageUserController@trialuser')->name('trial_users.view');
    Route::get('/trial-user/businesses','ManageUserController@businesses');
    ...
    Route::group(['prefix' => 'message'], function () {
        ...
        Route::get('/send-sms', 'MessageController@sendSms')->name('message.sendSms');
        Route::get('/message-history', 'MessageController@messageHistory');
        Route::get('/sms-template', 'MessageController@smsTemplate')->name('message.smsTemplate');
        Route::get('/group-sms', 'MessageController@groupSms')->name('message.groupSms');
        Route::get('/buy-sms', 'MessageController@buySms')->name('message.buySms');
        Route::post('/message/pay', 'MessageController@pay')->name('message.pay');

        Route::get('/templates/listing', 'MessageController@templateListing')->name('templates.listing');
        Route::post('/templates/templateCreate', 'MessageController@templateCreate')->name('templates.templateCreate');
        Route::delete('/templates/{id}', 'MessageController@templateDestroy')->name('templates.destroy');
        Route::get('/templates/{id}/edit', 'MessageController@templateEdit')->name('templates.edit');
        Route::put('/templates/{id}', 'MessageController@templateUpdate')->name('templates.update');

        Route::get('/groups/listing', 'MessageController@groupListing')->name('groups.listing');
        Route::post('/groups/groupCreate', 'MessageController@groupCreate')->name('groups.groupCreate');
        Route::delete('/groups/{id}', 'MessageController@groupDestroy')->name('groups.destroy');
        Route::get('/groups/{id}/edit', 'MessageController@groupEdit')->name('groups.edit');
        Route::put('/groups/{id}', 'MessageController@groupUpdate')->name('groups.update');

        Route::get('get-message-details/{id}', 'MessageController@templateSMSFind');

        Route::post('/sms/singleSMSSend', 'MessageController@singleSMSSend')->name('sms.singleSMSSend');
        Route::post('/sms/groupSMSSend', 'MessageController@groupSMSSend')->name('sms.groupSMSSend');

        Route::post('/save-settings', 'MessageController@saveSettings')->name('save-settings');
    ...
    Route::get('get-draft-message-details/{id}','NotificationSmsController@draftmessage');
    Route::resource('smsnotification', 'NotificationSmsController');
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('/sells/invoice-print/', 'SellPosController@invoicePrint')->name('invoice-print');
