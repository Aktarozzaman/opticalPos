            ...
            <div class="row">
                ...
                <div class="col-md-3 individual">
                    <div class="form-group">
                        ...
                        {!! Form::text('first_name', null, ['class' => 'form-control', 'placeholder' => __( 'Full Name' ) ]); !!}
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('mobile', __('contact.mobile') . ':*', ['class' => 'text-danger']) !!}
                        <div class="input-group">
                          <span class="input-group-addon">
                            ...
                            {!! Form::tel('mobile', null, [
                                ...
                                'required',
                                 // Use HTML5 pattern attribute to specify the pattern
                ...
                @endphp
                    @if(!empty($custom_labels['contact']['is_custom_field_1_contact_show']))
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_2_contact_show']))
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_3_contact_show']))
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_4_contact_show']))
                         <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_5_contact_show']))
                         <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_6_contact_show']))
                       <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_7_contact_show']))
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_8_contact_show']))
                          <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                        @if(!empty($custom_labels['contact']['is_custom_field_9_contact_show']))
                           <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_custom_field_10_contact_show']))
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @endif
                    @if(!empty($custom_labels['contact']['is_lens_type_show']))
                        <div class="col-md-3 ">
                            <div class="form-group">
                                {!! Form::label('lens_type', __('lang_v1.lens_type') . ':' ) !!}
                                <div class="input-group">
                                    <span class="input-group-addon"> <i class="fas fa fa-life-ring"></i> </span>
                                    {!! Form::select('lens_type',
                                        [
                                            '' => __('messages.please_select'), // Placeholder option
                                            'Unifocal' => __('Unifocal'),
                                            'Byfocal' => __('Byfocal'),
                                            'Progressive' => __('Progressive'),
                                            'Moon' => __('Moon'),
                                            'Univision D' => __('Univision D'),
                                            'Contact Lense' => __('Contact Lense'),
                                        ],
                                        null , // Selected value (optional)
                                        ['class' => 'form-control', 'id' => 'crm_life_stage']  // Attributes
                                    ); !!}
                                </div>
                            </div>
                        </div>
                    @endif
                    @if(!empty($custom_labels['contact']['is_remarks_show']))
                            @php
                            $business_id = request()->session()->get('user.business_id');
                            $remarks=\App\Category::where('business_id',$business_id)->where('parent_id', '!=', 0)->pluck('name', 'id')->toArray();
                        @endphp
                        <div class="col-md-3 ">
                            <div class="form-group">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    {!! Form::select('remarks', $remarks, null , ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!}
                                </div>
                            </div>
                        </div>
                    @endif
