<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	{{ config('app.name', 'CyberSparkPOS') }} - V{{config('author.app_version')}} | Copyright &copy; {{ date('Y') }} All rights reserved.
    </small>
    ...
    <div class="btn-group pull-right">
      Software Developed by <a href="https://cybersparkglobal.com/" target="_blank">CyberSpark</a>&nbsp; <i class="fas fa-phone-alt"></i> +01685 375652
    </div>
</footer>