     ...
     <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_1_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_1_contact_show']) && $custom_labels['contact']['is_custom_field_1_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_2_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_2_contact_show']) && $custom_labels['contact']['is_custom_field_2_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_3_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_3_contact_show']) && $custom_labels['contact']['is_custom_field_3_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_4_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_4_contact_show']) && $custom_labels['contact']['is_custom_field_4_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_5_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_5_contact_show']) && $custom_labels['contact']['is_custom_field_5_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_6_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_6_contact_show']) && $custom_labels['contact']['is_custom_field_6_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_7_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_7_contact_show']) && $custom_labels['contact']['is_custom_field_7_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_8_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_8_contact_show']) && $custom_labels['contact']['is_custom_field_8_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_9_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_9_contact_show']) && $custom_labels['contact']['is_custom_field_9_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group-addon">
                    <label>
                        <input type="checkbox" name="custom_labels[contact][is_custom_field_10_contact_show]" value="1" @if(!empty($custom_labels['contact']['is_custom_field_10_contact_show']) && $custom_labels['contact']['is_custom_field_10_contact_show'] == 1) checked @endif > @lang('lang_v1.is_show_for_contact')
                    </label>
                </div>
                </div>
            </div>
         ...
         <div class="col-sm-4">
             <div class="form-group">
                 ...
                 <div class="input-group">
                     {!! Form::text('remarks', __('lang_v1.remarks') . ':',['class' => 'form-control','readonly' => 'readonly'] ) !!}
                     <div class="input-group-addon">
                         <label>
                             <input  type="checkbox" name="custom_labels[contact][is_remarks_show]" value="1" @if(!empty($custom_labels['contact']['is_remarks_show']) && $custom_labels['contact']['is_remarks_show'] == 1) checked @endif >@lang('lang_v1.is_show_for_contact')
                         </label>
                     </div>
                 </div>
             </div>
         ...
         <div class="col-sm-4">
             <div class="form-group">
                 {!! Form::label('remarks', __('lang_v1.lens_type') . ':' ) !!}
                 <div class="input-group">
                     {!! Form::text('lens_type', __('lang_v1.lens_type') . ':',['class' => 'form-control','readonly' => 'readonly'] ) !!}
                     <div class="input-group-addon">
                         <label>
                             <input type="checkbox"  name="custom_labels[contact][is_lens_type_show]" value="1" @if(!empty($custom_labels['contact']['is_lens_type_show']) && $custom_labels['contact']['is_lens_type_show'] == 1) checked @endif >@lang('lang_v1.is_show_for_contact')
                         </label>
                     </div>
                 </div>
             </div>
