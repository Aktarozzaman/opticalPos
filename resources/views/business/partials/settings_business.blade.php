<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="clearfix"></div>
        <div class="col-sm-4" id="custom-currency-div">
            <div class="form-group">
                <div>
                    <label>
                        <b>@lang('lang_v1.custom_currency')</b>
                    </label>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control" placeholder="Input Custom Currency "
                        name="symbol">
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                {!! Form::label('sms_amount', __('Available SMS')) !!}
                {!! Form::text('sms_amount', $business->sms_amount, [
                    'class' => 'form-control',
                    'placeholder' => __('Available SMS'),
                    'readonly',
                ]) !!}
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        // Hide the custom-currency-div initially
        $("#custom-currency-div").hide();

        // Listen for changes in the currency_id select element
        $("select[name='currency_id']").on("change", function () {
            var selectedValue = $(this).val();

            // Check if the selected value is 1
            if (selectedValue == 1) {
                // If selected value is 1, show the custom-currency-div
                $("#custom-currency-div").show();
            } else {
                // If not, hide the custom-currency-div
                $("#custom-currency-div").hide();
            }
        });
    });
