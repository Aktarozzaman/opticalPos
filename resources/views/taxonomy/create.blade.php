<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            {{-- add as chld category   --}}

            @if (!empty($parent_categories) && $enable_sub_category)
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('add_as_child_cat', 1, false, [
                                'class' => 'toggler',
                                'data-toggle_id' => 'sub_parent_cat_div',
                            ]) !!} @lang('lang_v1.add_as_child_category')
                        </label>
                    </div>
                </div>
                <div class="form-group hide" id="sub_parent_cat_div">
                    {!! Form::label('child_parent_id', __('category.select_parent_category') . ':') !!}
                    {!! Form::select('child_parent_id', $parent_categories, null, ['class' => 'form-control']) !!}

                    {!! Form::label('sub_parent_id', 'Select sub parent category' . ':') !!}
                    {!! Form::select('sub_parent_id', [], null, [
