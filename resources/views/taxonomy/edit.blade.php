      ...
      <div class="modal-body">
          ...
          @if (!empty($parent_categories) && $enable_sub_category)
              <div class="form-group">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('add_as_sub_cat', 1, !$is_parent && !$is_child, [
                              'class' => 'toggler',
              ...
              <div class="form-group @if ($is_parent || $is_child) {{ 'hide' }} @endif"
                  id="parent_cat_div">
          ...
          @if (!empty($parent_categories) && $enable_sub_category)
              <div class="form-group">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('add_as_child_cat', 1, $is_child, [
                              'class' => 'toggler',
                              'data-toggle_id' => 'sub_parent_cat_div',
                          ]) !!} Add as child category
                      </label>
                  </div>
              </div>
              <div class="form-group @if (!$is_child) {{ 'hide' }} @endif"
                  id="sub_parent_cat_div">
                  {!! Form::label('child_parent_id', __('category.select_parent_category') . ':') !!}
                  {!! Form::select('child_parent_id', $parent_categories, $selected_parent, ['class' => 'form-control']) !!}

                  {!! Form::label('sub_parent_id', 'Select sub parent category' . ':') !!}
                  {!! Form::select('sub_parent_id', $sub_parent_categories, $selected_sub_parent, [
