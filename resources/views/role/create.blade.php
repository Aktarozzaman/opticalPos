...
@section('content')
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase_order.view_own', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_purchase_order') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase_order.view_all', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_purchase_order') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="col-md-9">
                    @if (in_array('add_sale', $enabled_modules))
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'direct_sell.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_sale') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'so.view_own', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_so') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'so.view_all', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_so') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'all_expense.access', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.access_all_expense') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
            ...
            <div class="row check_group">
              <div class="col-md-3">
                  <h4>@lang('role.trial_users') @show_tooltip(__('tooltip.trialPermission'))</h4>
              </div>
              <div class="col-md-9">
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('permissions[]', 'trial_users.view', true, ['class' => 'input-icheck']) !!} {{ __('role.trial.view') }}
                          </label>
                      </div>
                  </div>
              </div>
