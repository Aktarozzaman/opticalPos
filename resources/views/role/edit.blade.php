            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'access_own_shipping', in_array('access_own_shipping', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'trial_users.view',in_array('trial_users.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('role.trial.view') }}
                            </label>
                        </div>
                    </div>
                </div>
