...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('sell_list_filter_payment_status', ['paid' => __('lang_v1.paid'), 'partial' => __('lang_v1.partial'), 'due' => __('lang_v1.due'), 'partial_and_due' => __('lang_v1.partial_and_due'), 'overdue' => __('lang_v1.overdue')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
    </div>
</div>
@endif
