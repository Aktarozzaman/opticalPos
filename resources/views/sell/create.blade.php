...
@endif
	...
	<div class="row">
		...
		<div class="col-sm-12 text-right">
			<button type="button" id="submit-sell" class="btn btn-primary">@lang('messages.save')</button>
			<button type="button" id="save-and-print" class="btn btn-primary">@lang('lang_v1.save_and_print')</button>
		</div>
	</div>
