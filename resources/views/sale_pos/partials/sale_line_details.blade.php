    ...
    @foreach($sell->sell_lines as $sell_line)
        <tr>
            ...
            <td>
               ...
               {{ $sell_line->variations->product_variation->name != 'DUMMY'? ' - '.$sell_line->variations->product_variation->name :  ''}}
               {{ $sell_line->variations->name != 'DUMMY' ? ' - '.$sell_line->variations->name : ''}},
                - {{getImeiText(json_decode($sell_line->imei_ids))}},
                @endif
