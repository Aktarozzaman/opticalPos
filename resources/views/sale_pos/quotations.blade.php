        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'sub_status', // Add sub_status column definition
                        name: 'sub_status',
                        render: function(data, type, full, meta) {
                            if (type === 'display') {
                                ...
                                if (data === 'proforma') {
                                    statusLabel =
                                        '<span class="label bg-gray">@lang('lang_v1.proforma_invoice')</span>';
                                } else if (data === 'quotation') {
                                    statusLabel =
                                        '<span class="label bg-primary" >@lang('lang_v1.quotation')</span>';
                                } else if (data === 'draft') {
                                    statusLabel =
                                        '<span class="label bg-primary" >@lang('lang_v1.draft')</span>';
                                } else {
                                    statusLabel = '<span class="label label-default">' + data +
                                        '</span>';
                                }
                                return statusLabel;
                            }
