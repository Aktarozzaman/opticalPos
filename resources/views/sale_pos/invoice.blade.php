...
<section class="content no-print">
	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-9 @else col-md-10 col-md-offset-1 @endif no-padding pr-12">
				...
				<div class="col-md-3 no-padding">
					@include('sale_pos.partials.pos_calculate')
				</div>
				@endif
			</div>
		</div>
