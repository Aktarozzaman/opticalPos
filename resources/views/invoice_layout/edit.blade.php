      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('contact_custom_fields[]', 'custom_field8', in_array('custom_field8', $contact_custom_fields), ['class' => 'input-icheck']); !!} {{ $custom_labels['contact']['custom_field_8'] ?? __('lang_v1.contact_custom_field8') }}</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('contact_custom_fields[]', 'custom_field9', in_array('custom_field9', $contact_custom_fields), ['class' => 'input-icheck']); !!} {{ $custom_labels['contact']['custom_field_9'] ?? __('lang_v1.contact_custom_field9') }}</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('contact_custom_fields[]', 'custom_field10', in_array('custom_field10', $contact_custom_fields), ['class' => 'input-icheck']); !!} {{ $custom_labels['contact']['custom_field_10'] ?? __('lang_v1.contact_custom_field10') }}</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('contact_custom_fields[]', 'lens_type', in_array('lens_type', $contact_custom_fields), ['class' => 'input-icheck']); !!} {{ $custom_labels['contact']['lens_type'] ?? __('lang_v1.lens_type') }}</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('contact_custom_fields[]', 'remarks', in_array('remarks', $contact_custom_fields), ['class' => 'input-icheck']); !!} {{ $custom_labels['contact']['remarks'] ?? __('lang_v1.remarks') }}</label>
            </div>
          </div>
        </div>
      <div class="clearfix"></div>
