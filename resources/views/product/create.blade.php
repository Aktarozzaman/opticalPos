                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('unit.create')) disabled @endif
                                    class="btn btn-default bg-white btn-modal"
                    ...
                    <div class="form-group">
                        ...
                        <label>
                            {!! Form::checkbox(
                                'is_accessories',
                                1,
                                !empty($duplicate_product) ? $duplicate_product->is_accessories : false,
                                ['class' => 'input-icheck', 'id' => 'is_accessories'],
                            ) !!} <strong>{{-- @lang('product.is_accessories') --}} Has IMEI or Serial Number</strong>
                        </label>
                    </div>
                </div>
                <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('unit.create')) disabled @endif
                                    class="btn btn-default bg-white btn-modal"
                                    data-href="{{ action('TaxonomyController@create') }}?type=product&quick_add=true"
                                    title="@lang('unit.add_unit')" data-container=".view_modal"><i
                                        class="fa fa-plus-circle text-primary fa-lg"></i></button>
                            </span>
                        </div>
                ...
                <div class="col-sm-4 @if (!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
                    <div class="form-group">
                        ...
                        {!! Form::number(
                            ...
                            ['class' => 'form-control', 'placeholder' => __('product.alert_quantity'), 'min' => '0'],
                        ) !!}
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="text-center">
                    <div class="btn-group">
                        ...
                        @endcan
                            <button type="submit" value="save_n_add_purchases" class="btn btn-success submit_product_form">@lang('messages.save_n_add_purchases')</button>
    ...
    <script type="text/javascript">
        ...
        function show_product_variant_form(selected_variant) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                data: {
                    selected_variant_value: selected_variant
                },
                success: function(result) {
                    if (result) {
