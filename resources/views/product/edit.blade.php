            ...
            <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('unit.create')) disabled @endif
                                    class="btn btn-default bg-white quick_add_unit btn-modal"
                    ...
                    <div class="form-group">
                        ...
                        @if ($imei)
                            ...
                            <label>
                                ...
                                {!! Form::checkbox('is_accessories', 1, !empty($product) ? 1 : true, [
                                    'class' => 'input-icheck',
                                    'id' => 'is_accessories',
                                    'disabled' => 'disabled',
                        ...
                        @else
                            <label>
                                {!! Form::checkbox('is_accessories', 1, !empty($product) ? 0 : true, [
                                    'class' => 'input-icheck',
                                    'id' => 'is_accessories',
                                ]) !!} <strong>{{-- @lang('product.is_accessories') --}} Has IMEI or Serial Number</strong>
                            </label>
                ...
                <div class="col-sm-4 @if (!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
                    <div class="form-group">
                        ...
                        {!! Form::select('sub_sub_category_id', $sub_sub_categories, $product->sub_sub_category_id, [
                            'placeholder' => __('messages.please_select'),
                            'class' => 'form-control select2',
                        ]) !!}
                    </div>
            ...
            <div class="row">
                ...
                @if ($product->type == 'single')
                    <div class="form-group col-sm-12">
                        @include('product.partials.edit_single_product_form_part')
                    </div>
                @endif

                @if ($product->type == 'variable')
                    @include('product.edit_product_variable')
                @endif
            @endcomponent
