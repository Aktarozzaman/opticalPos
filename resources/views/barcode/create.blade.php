        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.top_margin'), 'min' => 0, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.left_margin'), 'min' => 0, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.width'), 'min' => 0.1, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.height'), 'min' => 0.1, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.paper_width'), 'min' => 0.1, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-sm-6 paper_height_div">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.paper_height'), 'min' => 0.1, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('barcode.row_distance'), 'min' => 0, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('col_distance', __('barcode.col_distance') . ' ('. __('barcode.in_in') . '):*') !!}
             <div class="input-group">
              ...
              'placeholder' => __('barcode.col_distance'), 'min' => 0, 'step' => 0.000001, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
