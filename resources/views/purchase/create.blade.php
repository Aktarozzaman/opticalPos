...
<style>
	...
	.supplyRedesign .box-header {
		background-color: #607d8b;
	}

	.supplyRedesign .box-title {
		color: #fff;
		font-weight: bold;
		font-size: 24px;
	}
...
{{--							<th>@lang( 'purchase.imei_number' )</th>--}}
	...
	@component('components.widget', ['class' => 'box-primary supplyRedesign supplier_name_div', 'title' => __('Supply Payment')])
	<div class="box-body payment_row">
		...
		<div class="row">
		   	...
		   	@if ($messageSettingActiveCheck == null)
                
            @elseif ($messageSettingActiveCheck->enable_sale == 1)
			<div class="col-md-6">
				<div class="form-group">
					<label></label><br><br>
			...
			<div class="col-sm-6">
				<div class="pull-right"><strong class="text-danger">@lang('purchase.payment_due'):</strong> <span id="payment_due">0.00</span></div>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-sm-12">
				<button type="button" id="submit_purchase_form" class="btn btn-primary pull-right">@lang('messages.save')</button>
			</div>
		</div>
	</div>
	@endcomponent
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var productId = queryString;
		if (productId){
			get_purchase_entry_row(productId,0)
		}
	});
