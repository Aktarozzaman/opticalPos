...
{{--            <td>--}}
{{--                <div class="imei">--}}
{{--                    <div class="single_imei">--}}
{{--                        <div><input type="text" name="imei1[{{$product->id}}][{{$variation->id}}][]"  placeholder="Enter IMEI 1 / Serial 1"></div>--}}
{{--                        <div><input type="text" name="imei2[{{$product->id}}][{{$variation->id}}][]"  placeholder="Enter IMEI 2 / Serial 2"></div><br>--}}
{{--                    </div>--}}
{{--                    --}}
{{--                </div>--}}
{{--            </td>--}}
