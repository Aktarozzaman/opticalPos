...
<section class="content">
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary supplyRedesign','title' => __('Supply Payment')])
        <div class="row">
            <div class="col-sm-12">
                <table class="table">
                  <tr>
    ...
    <div class="row">
        <div class="col-sm-12">
          <button type="button" id="submit_purchase_form" class="btn btn-primary pull-right">@lang('messages.update')</button>
        </div>
    </div>
{!! Form::close() !!}
</section>
