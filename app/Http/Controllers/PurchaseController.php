...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('purchase.index')
            ->with(compact('business_locations', 'suppliers', 'orderStatuses','remarks'));
    }
    ...
    public function create()
    {
        ...
        return view('purchase.create')
            ->with(compact('taxes', 'orderStatuses','remarks', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'common_settings', 'messageSettingActiveCheck'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $supplierInfo = Contact::where('id', $request->contact_id)->first();
