...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if (!empty(request()->input('payment_status')) && request()->input('payment_status') != 'overdue' && request()->input('payment_status') != 'partial_and_due') {
            ...
            } elseif (request()->input('payment_status') == 'partial_and_due') {
                $sells->whereIn('transactions.payment_status', ['partial', 'due']);
            }
