...
class TransactionUtil extends Util
{
    ...
    public function createSellTransaction($business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
        ...
        $customer_data = Contact::where('id', $input['contact_id'])->where('business_id', $business_id)->first();
        ...
        $transaction = Transaction::create([
            ...
            'custom_field_1' => !empty($customer_data['custom_field1']) ? $customer_data['custom_field1'] : null,
            'custom_field_2' => !empty($customer_data['custom_field2']) ? $customer_data['custom_field2'] : null,
            'custom_field_3' => !empty($customer_data['custom_field3']) ? $customer_data['custom_field3'] : null,
            'custom_field_4' => !empty($customer_data['custom_field4']) ? $customer_data['custom_field4'] : null,
            'custom_field_5' => !empty($customer_data['custom_field5']) ? $customer_data['custom_field5'] : null,
            'custom_field_6' => !empty($customer_data['custom_field6']) ? $customer_data['custom_field6'] : null,
            'custom_field_7' => !empty($customer_data['custom_field7']) ? $customer_data['custom_field7'] : null,
            'custom_field_8' => !empty($customer_data['custom_field8']) ? $customer_data['custom_field8'] : null,
            'custom_field_9' => !empty($customer_data['custom_field9']) ? $customer_data['custom_field9'] : null,
            'custom_field_10' => !empty($customer_data['custom_field10']) ? $customer_data['custom_field10'] : null,
            'lens_type' => !empty($customer_data['lens_type']) ? $customer_data['lens_type'] : null,
            'remarks' => !empty($customer_data['remarks']) ? $customer_data['remarks'] : null,
    ...
    public function createOrUpdateSellLines($transaction, $products, $location_id, $return_deleted = false, $status_before = null, $extra_line_parameters = [], $uf_data = true)
    {
        ...
        foreach ($products as $product) {
            ...
            if (!empty($product['transaction_sell_lines_id'])) {
                            ...
                            if (!empty($product['modifier_sell_line_id'][$key])) {
                                ...
                                if (!empty($product['modifier_price'][$key])) {
                                    ...
                                    if (isset($product['imei_id']) && !empty($product['imei_id'])) {
                                        $new_arr['imei_id'] = json_encode($product['imei_id']);
                                    }
                ...
                if (isset($product['imei_id']) && !empty($product['imei_id'])) {
                    $line['imei_ids'] = json_encode($product['imei_id']);
                }
    ...
    public function editSellLine($product, $location_id, $status_before, $multiplier = 1)
    {
        ...
        $old_imei_ids = json_decode($sell_line->imei_ids);

        if ($old_imei_ids) {
            Imei::whereIn('id', $old_imei_ids)->update(['status' => 0]);
        }
        ...
        if (isset($product['imei_id']) && !empty($product['imei_id'])) {
            $new_arr['imei_ids'] = json_encode($product['imei_id']);

            Imei::whereIn('id', $product['imei_id'])->update(['status' => 1]);
        }
    ...
    public function deleteSellLines($transaction_line_ids, $location_id, $adjust_qty = true)
    {
        if (!empty($transaction_line_ids)) {
            ...
            foreach ($sell_lines as $line) {
                ...
                $imei_ids = json_decode($line->imei_ids);
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $output = [
            ...
            'contact_invoice_settings' => $il->contact_custom_fields,
        ];
...
//        print manufacturing coppy data
        $output['print_mf_copy'] = session()->get('print_mf_copy');
        $output['print_shop_copy'] = session()->get('print_shop_copy');
...
//            business custom labels name for contact
            $custom_labels=json_decode($business_details->custom_labels, true);
            $output['customer_custom_labels_name'] = $custom_labels['contact'];
            ...
            if (!empty($customer->custom_field1)) {
                $output['customer_custom_fields']['custom_field1'] = $customer->custom_field1;
            }
            if (!empty($customer->custom_field2) ){
                $output['customer_custom_fields']['custom_field2'] = $customer->custom_field2;
            }
            if (!empty($customer->custom_field3) ) {
                $output['customer_custom_fields']['custom_field3'] = $customer->custom_field3;
            }
            if (!empty($customer->custom_field4) ) {
                $output['customer_custom_fields']['custom_field4'] = $customer->custom_field4;
            }
            if (!empty($customer->custom_field5)) {
                $output['customer_custom_fields']['custom_field5'] = $customer->custom_field5;
            }
            if (!empty($customer->custom_field6)) {
                $output['customer_custom_fields']['custom_field6'] = $customer->custom_field6;
            }
            if (!empty($customer->custom_field7) ) {
                $output['customer_custom_fields']['custom_field7'] = $customer->custom_field7;
            }
            if (!empty($customer->custom_field8)) {
                $output['customer_custom_fields']['custom_field8'] = $customer->custom_field8;
            }
            if (!empty($customer->custom_field9)) {
                $output['customer_custom_fields']['custom_field9'] = $customer->custom_field4;
            }
            if (!empty($customer->custom_field10) ) {
                $output['customer_custom_fields']['custom_field10'] = $customer->custom_field10;
            }
            if (!empty($customer->lens_type) ) {
                $output['customer_custom_fields']['lens_type'] = $customer->lens_type;
            }
            if (!empty($customer->remarks) ) {
                $output['customer_custom_fields']['remarks'] = $customer->remarks;
            }
                      //To be used in pdfs
            $customer_address = [];
    ...
    protected function _receiptDetailsSellLines($lines, $il, $business_details)
    {
        ...
        foreach ($lines as $line) {
            ...
            if ($il->imei1 != 1) {
                $line_array['imei1'] = '';
                $line_array['show_imei_1'] = 0;
            }
            if ($il->imei2 != 1) {
                $line_array['imei1'] = '';
                $line_array['show_imei_2'] = 0;
            }
            if ($il->show_sku == 1) {
