...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        InvoiceLayout::create([
            ...
            'prev_bal_label' => 'Previous Due Amount',
            'change_return_label' => 'Return Money',
            'show_landmark' => 1,
            'show_city' => 0,
            'show_state' => 0,
            'show_zip_code' => 0,
            ...
            'common_settings' => [
                ...
                "item_discount_label" => null,
                "show_warranty_name" => "1",
                "show_warranty_exp_date" => "1",
                "show_total_in_words" => "1",
                "num_to_word_format" => "international",
            ],
            'show_sale_description' => 1,
        ]);
        ...
        $first_unit = Unit::create($unit);

        $business->default_unit = $first_unit->id;
        $business->save();
